    ...
    , ui(new Ui::TestWebView)
{
    ...
    pWebView1_1->load(QUrl(QStringLiteral("http://10.10.14.50:8080/?action=stream")));
    ui->pQVBoxLayout1_1->addWidget(pWebView1_1);

    pWebView1_2 = new QWebEngineView(this);
    pWebView1_2->load(QUrl(QStringLiteral("http://10.10.14.27:8080/?action=stream")));
    ui->pQVBoxLayout1_2->addWidget(pWebView1_2);


    pWebView2_1 = new QWebEngineView(this);
    pWebView2_1->load(QUrl(QStringLiteral("http://10.10.14.26:8080/?action=stream")));
    ui->pQVBoxLayout2_1->addWidget(pWebView2_1);

    pWebView2_2 = new QWebEngineView(this);
    pWebView2_2->load(QUrl(QStringLiteral("http://10.10.14.39:8080/?action=stream")));
