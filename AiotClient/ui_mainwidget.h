...
public:
    ...
    void retranslateUi(QWidget *MainWidget)
    {
        ...
        pTabWidget->setTabText(pTabWidget->indexOf(pTab6), QCoreApplication::translate("MainWidget", "Tab6", nullptr));
        pTabWidget->setTabText(pTabWidget->indexOf(pTab7), QCoreApplication::translate("MainWidget", "Tab7", nullptr));
    } // retranslateUi
