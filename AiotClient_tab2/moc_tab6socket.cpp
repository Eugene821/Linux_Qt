/****************************************************************************
** Meta object code from reading C++ file 'tab6socket.h'
**
...
#include "../SensorMan_lyj/tab6socket.h"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'tab6socket.h' doesn't include <QObject>."
...
QT_MOC_LITERAL(3, 29, 15), // "tab3RecvDataSig"
QT_MOC_LITERAL(4, 45, 15), // "tab4RecvDataSig"
QT_MOC_LITERAL(5, 61, 15), // "tab5RecvDataSig"
QT_MOC_LITERAL(6, 77, 27), // "on_pPBServerConnect_clicked"
QT_MOC_LITERAL(7, 105, 7), // "checked"
QT_MOC_LITERAL(8, 113, 20), // "socketRecvUpdateSlot"
QT_MOC_LITERAL(9, 134, 24), // "on_pPBSendButton_clicked"
QT_MOC_LITERAL(10, 159, 12) // "keyboardSlot"
    ...
    "on_pPBSendButton_clicked\0keyboardSlot"
};
...
void Tab2SockeClient::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (Tab2SockeClient::*)(QString );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Tab2SockeClient::tab3RecvDataSig)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (Tab2SockeClient::*)(QString );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Tab2SockeClient::tab4RecvDataSig)) {
                *result = 2;
                return;
            }
        }
        {
            using _t = void (Tab2SockeClient::*)(QString );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Tab2SockeClient::tab5RecvDataSig)) {
                *result = 3;
                return;
            }
        }
...
// SIGNAL 1
void Tab2SockeClient::tab3RecvDataSig(QString _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
...
// SIGNAL 2
void Tab2SockeClient::tab4RecvDataSig(QString _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
...
// SIGNAL 3
void Tab2SockeClient::tab5RecvDataSig(QString _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
